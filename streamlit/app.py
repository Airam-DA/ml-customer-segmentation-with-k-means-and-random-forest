...
# Custom CSS for light theme with light grey as the dominant color
st.markdown("""
    <style>
        body {
...
if input_method == "Comma Separated List":
    ...
    # Parse the input string and convert it into a list
    if input_string:
        try:
...
# 2. Individual Entries Input
    ...
    # Combine all individual entries into a list
    input_data = [
...
# 3. Sliders Input (Group sliders into 3 per line)
    ...
    # Combine all slider values into a list
    input_data = [
        balance, balance_frequency, purchases, oneoff_purchases, installments_purchases, cash_advance,
        purchases_frequency, oneoff_purchases_frequency, purchases_installments_frequency, cash_advance_frequency,
        cash_advance_trx, purchases_trx, credit_limit, payments, minimum_payments, prc_full_payment, tenure
...
if submitted and input_data is not None:
    # Predict the cluster for the entered customer data
...
""", unsafe_allow_html=True)
    ...
    # Filter dataset by predicted cluster and ensure the cluster column is present
    ...
    # 1. Pairplot to visualize relationships between the most important features
    ...
    # 2. Correlation heatmap for the dataset
    ...
    # 3. Distribution plots for important features
    ...
    # 4. Bar plot for cluster size distribution
    ...
    # 5. Box plot for balance by cluster
